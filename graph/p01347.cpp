...
Result perform_kahn(int n, const vector<vector<int>> &adj,
...
int main()
{
    ...
    for (int idx = 0; idx < m; ++idx)
    {
        ...
        {
            result = "Inconsistency found after " + to_string(idx + 1) +
                     " relations.";
            inconsistent = true;
            break;
        }
        ...
        {
            result = "Sorted sequence determined after " + to_string(idx + 1) +
                     " relations: " + res.order + ".";
            determined = true;
            break;
        }
